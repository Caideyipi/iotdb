...
public class TNonblockingSSLSocket extends TNonblockingSocket {
  private static final Logger LOGGER = LoggerFactory.getLogger(TNonblockingSSLSocket.class);
  ...
  public TNonblockingSSLSocket(String host, int port, int timeout, SSLContext sslContext)
