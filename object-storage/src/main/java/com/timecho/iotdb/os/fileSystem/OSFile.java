...
public class OSFile extends File {
  ...
  private static String concatPath(String parent, String child) {
    if (parent.endsWith(ObjectStorageConstant.FILE_SEPARATOR)) {
      return parent + child;
    } else {
      return parent + ObjectStorageConstant.FILE_SEPARATOR + child;
    }
  }
  ...
  public File getParentFile() {
    int lastSeparatorIdx = osUri.getKey().lastIndexOf(ObjectStorageConstant.FILE_SEPARATOR);
