...
from iotdb.ainode.process.task import (ForecastAutoTuningTrainingTask,
...
class NoDaemonProcess(multiprocessing.Process):
    """
    Process class that does not daemonize on start.
    """
...
class NestablePool(multiprocessing.pool.Pool):
    """
    A multiprocessing pool that can be nested. Subprocesses such as the dataloader process that
    created while training a model cannot be nested unless created as a NoDaemonProcess.
    """
