...
1AINODE_CLUSTER_INGRESS_PASSWORD = "TimechoDB@2021"
...
1)
1TRAINING_LOG_FILE_NAME_PREFIX_TEMPLATE = (
1    "log_training_rank_{}_"  # example: log_training_rank_0_all.log
1)
1
...
1
1    # Training status codes
1    INVALID_TRAINING_CONFIG = 1550
1    TRAINING_INTERNAL_ERROR = 1551
1
