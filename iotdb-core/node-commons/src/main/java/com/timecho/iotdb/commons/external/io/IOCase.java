 ...
 * comparisons.
 *
 * <p>Wherever possible, you should use the {@code check} methods in this class to compare file
 * names.
 *
 * @since 1.3
 */
public enum IOCase {
  ...
  public static IOCase forName(final String name) {
    return Stream.of(IOCase.values())
        .filter(ioCase -> ioCase.getName().equals(name))
        .findFirst()
