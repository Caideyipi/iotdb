...
import com.timecho.iotdb.commons.external.io.FileUtils;
import com.timecho.iotdb.commons.external.io.file.attribute.FileTimes;
 ...
 *   <li>Last Modified Date/Time (see {@link FileUtils#lastModifiedUnchecked(File)})
 ...
 *
 * <p><em>Serialization is deprecated and will be removed in 3.0.</em>
 *
...
public class FileEntry implements Serializable {
   ...
   *
   * <p>This implementation refreshes the {@code name}, {@code exists}, {@code directory}, {@code
   * lastModified} and {@code length} properties.
   *
   * <p>The {@code exists}, {@code directory}, {@code lastModified} and {@code length} properties
  ...
  public boolean refresh(final File file) {
    ...
    return exists != origExists
        || !lastModified.equals(origLastModified)
