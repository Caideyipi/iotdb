...
import com.timecho.iotdb.commons.external.io.comparator.NameFileComparator;
import org.apache.tsfile.external.commons.io.IOCase;
...
public class FileAlterationObserver implements Serializable {
  ...
  public FileAlterationObserver(
      final File directory, final FileFilter fileFilter, final IOCase ioCase) {
  ...
  protected FileAlterationObserver(
      final FileEntry rootEntry, final FileFilter fileFilter, final IOCase ioCase) {
  ...
  private void checkAndNotify(
    ...
    final FileEntry[] current =
        files.length > 0 ? new FileEntry[files.length] : FileEntry.EMPTY_FILE_ENTRY_ARRAY;
