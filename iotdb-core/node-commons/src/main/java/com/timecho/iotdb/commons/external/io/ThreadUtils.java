...
public final class ThreadUtils {
   ...
   * else it deems appropriate. Read {@link Thread#sleep(long, int)}} for further interesting
   * details.
   *
  ...
  public static void sleep(final Duration duration) throws InterruptedException {
    // Using this method avoids depending on the vagaries of the precision and accuracy of system
