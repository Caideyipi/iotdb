...
public class PatternListEntry {
  ...
  /**
   * Constructs a new PatternListEntry with the specified value and delimits components of the
   * pattern by componentDelimiter specified.
   *
   * <p>If the componentDelimiter is null, then there will only be one component.
   *
   * @param value
