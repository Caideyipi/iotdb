...
import com.timecho.iotdb.commons.external.codec.BinaryDecoder;
import com.timecho.iotdb.commons.external.codec.BinaryEncoder;
import com.timecho.iotdb.commons.external.codec.CodecPolicy;
import com.timecho.iotdb.commons.external.codec.DecoderException;
import com.timecho.iotdb.commons.external.codec.EncoderException;
...
public abstract class BaseNCodec implements BinaryEncoder, BinaryDecoder {
  ...
  public byte[] decode(final String pArray) {
    return decode(org.apache.tsfile.external.commons.codec.binary.StringUtils.getBytesUtf8(pArray));
  }
