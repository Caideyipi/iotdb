...
public enum FileSystem {
   ...
   * Windows file system.
   *
   * <p>The reserved characters are defined in the <a
   * href="https://docs.microsoft.com/en-us/windows/win32/fileio/naming-a-file">Naming Conventions
   * (microsoft.com)</a>.
   *
   * @see <a href="https://docs.microsoft.com/en-us/windows/win32/fileio/naming-a-file">Naming
   *     Conventions (microsoft.com)</a>
   * @see <a
  ...
  WINDOWS(
      ...
      new String[] {
        ...
        "CONIN$", "CONOUT$", "LPT1", "LPT2", "LPT3", "LPT4", "LPT5", "LPT6", "LPT7", "LPT8", "LPT9",
        "NUL", "PRN"
      },
      true,
      true,
  ...
  FileSystem(
      ...
      final int[] illegalFileNameChars,
