...
import org.apache.iotdb.mlnode.rpc.thrift.TInferenceReq;
import org.apache.iotdb.mlnode.rpc.thrift.TInferenceResp;
import org.apache.iotdb.mlnode.rpc.thrift.TRegisterModelReq;
import org.apache.iotdb.mlnode.rpc.thrift.TRegisterModelResp;
...
public class MLNodeClient implements AutoCloseable, ThriftClient {
  ...
  public static class Factory extends ThriftClientFactory<TEndPoint, MLNodeClient> {
    ...
    @Override
    public PooledObject<MLNodeClient> makeObject(TEndPoint endPoint) throws Exception {
      return new DefaultPooledObject<>(
          new MLNodeClient(thriftClientProperty, endPoint, clientManager));
    }
