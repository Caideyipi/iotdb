...
public interface IMeasurementInfo {
  ...
  /**
   * Check if this measurement is invalid (original physical path after renaming).
   *
   * @return true if this measurement is invalid, false otherwise
   */
  boolean isInvalid();

  /**
   * Set the INVALID flag for this measurement.
   *
   * @param isInvalid true if this measurement is invalid, false otherwise
   */
