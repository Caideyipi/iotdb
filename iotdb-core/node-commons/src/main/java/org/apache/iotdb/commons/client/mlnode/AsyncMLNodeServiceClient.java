...
public class AsyncMLNodeServiceClient extends IMLNodeRPCService.AsyncClient
    implements ThriftClient {

  private final boolean printLogWhenEncounterException;
  private final TEndPoint endPoint;
  private final ClientManager<TEndPoint, AsyncMLNodeServiceClient> clientManager;

  public AsyncMLNodeServiceClient(
      ThriftClientProperty property,
      TEndPoint endPoint,
      TAsyncClientManager tClientManager,
      ClientManager<TEndPoint, AsyncMLNodeServiceClient> clientManager)
      throws IOException {
    super(
  ...
  public static class Factory
      extends AsyncThriftClientFactory<TEndPoint, AsyncMLNodeServiceClient> {
    ...
    public void destroyObject(
        TEndPoint endPoint, PooledObject<AsyncMLNodeServiceClient> pooledObject) {
      pooledObject.getObject().close();
    }

    @Override
    public PooledObject<AsyncMLNodeServiceClient> makeObject(TEndPoint endPoint) throws Exception {
      return new DefaultPooledObject<>(
          new AsyncMLNodeServiceClient(
