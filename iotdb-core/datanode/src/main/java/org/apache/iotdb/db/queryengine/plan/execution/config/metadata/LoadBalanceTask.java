...
public class LoadBalanceTask implements IConfigTask {
  ...
  public LoadBalanceTask(LoadBalance loadBalance) {
    this.statement = new LoadBalanceStatement(loadBalance.getTargetNodeIds());
  ...
  public ListenableFuture<ConfigTaskResult> execute(IConfigTaskExecutor configTaskExecutor)
    ...
    return configTaskExecutor.loadBalance(this);
  }
  ...
  public LoadBalanceStatement getStatement() {
    return statement;
  }
}
