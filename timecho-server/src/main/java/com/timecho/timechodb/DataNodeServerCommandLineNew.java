...
public class DataNodeServerCommandLineNew extends DataNodeServerCommandLine {
  private static final Logger LOGGER = LoggerFactory.getLogger(DataNodeServerCommandLineNew.class);
