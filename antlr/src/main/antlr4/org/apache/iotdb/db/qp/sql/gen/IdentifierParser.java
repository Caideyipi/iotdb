// Generated from /Users/ht/Documents/HTHou/timechodb/antlr/src/main/antlr4/org/apache/iotdb/db/qp/sql/IdentifierParser.g4 by ANTLR 4.12.0
...
public class IdentifierParser extends Parser {
	...
	public static final int
		...
		CLUSTER=24, COLLECTOR=25, CONCAT=26, CONDITION=27, CONFIGNODES=28, CONFIGURATION=29, 
		CONNECTOR=30, CONTINUOUS=31, CONTAIN=32, COUNT=33, CQ=34, CQS=35, CREATE=36, 
		DATA=37, DATABASE=38, DATABASES=39, DATANODEID=40, DATANODES=41, DEACTIVATE=42, 
		DEBUG=43, DELETE=44, DESC=45, DESCRIBE=46, DETAILS=47, DEVICE=48, DEVICES=49, 
		DISABLE=50, DISCARD=51, DROP=52, ELAPSEDTIME=53, END=54, ENDTIME=55, EVERY=56, 
		EXPLAIN=57, FILL=58, FILE=59, FIRST=60, FLUSH=61, FOR=62, FROM=63, FULL=64, 
		FUNCTION=65, FUNCTIONS=66, GLOBAL=67, GRANT=68, GROUP=69, HAVING=70, INDEX=71, 
		INFO=72, INSERT=73, INTO=74, KILL=75, LABEL=76, LAST=77, LATEST=78, LEVEL=79, 
		LIKE=80, LIMIT=81, LINEAR=82, LINK=83, LIST=84, LOAD=85, LOCAL=86, LOCK=87, 
		MERGE=88, METADATA=89, MIGRATE=90, MODEL=91, MODELS=92, NODEID=93, NODES=94, 
		NONE=95, NOW=96, NULLS=97, OF=98, OFF=99, OFFSET=100, ON=101, ORDER=102, 
		ONSUCCESS=103, PARTITION=104, PASSWORD=105, PATHS=106, PIPE=107, PIPES=108, 
		PIPESINK=109, PIPESINKS=110, PIPESINKTYPE=111, PIPEPLUGIN=112, PIPEPLUGINS=113, 
		POLICY=114, PREVIOUS=115, PREVIOUSUNTILLAST=116, PRIVILEGES=117, PROCESSLIST=118, 
		PROCESSOR=119, PROPERTY=120, PRUNE=121, QUERIES=122, QUERY=123, QUERYID=124, 
		QUOTA=125, RANGE=126, READONLY=127, REGEXP=128, REGION=129, REGIONID=130, 
		REGIONS=131, REMOVE=132, RENAME=133, RESAMPLE=134, RESOURCE=135, REPLACE=136, 
		REVOKE=137, ROLE=138, ROOT=139, ROUND=140, RUNNING=141, SCHEMA=142, SELECT=143, 
		SERIESSLOTID=144, SESSION=145, SET=146, SETTLE=147, SGLEVEL=148, SHOW=149, 
		SLIMIT=150, SOFFSET=151, SPACE=152, STORAGE=153, START=154, STARTTIME=155, 
		STATEFUL=156, STATELESS=157, STATEMENT=158, STOP=159, SUBSTRING=160, SYSTEM=161, 
		TAGS=162, TASK=163, TEMPLATE=164, TEMPLATES=165, THROTTLE=166, TIME=167, 
		TIMEOUT=168, TIMESERIES=169, TIMESLOTID=170, TIMEPARTITION=171, TIMESTAMP=172, 
		TO=173, TOLERANCE=174, TOP=175, TRACING=176, TRAILS=177, TRIGGER=178, 
		TRIGGERS=179, TTL=180, UNLINK=181, UNLOAD=182, UNSET=183, UPDATE=184, 
		UPSERT=185, URI=186, USED=187, USER=188, USING=189, VALUES=190, VARIABLES=191, 
		VARIATION=192, VERIFY=193, VERSION=194, VIEW=195, WATERMARK_EMBEDDING=196, 
		WHERE=197, WITH=198, WITHOUT=199, WRITABLE=200, CASE=201, WHEN=202, THEN=203, 
		ELSE=204, PRIVILEGE_VALUE=205, SET_STORAGE_GROUP=206, DELETE_STORAGE_GROUP=207, 
		CREATE_DATABASE=208, DELETE_DATABASE=209, CREATE_TIMESERIES=210, INSERT_TIMESERIES=211, 
		READ_TIMESERIES=212, DELETE_TIMESERIES=213, ALTER_TIMESERIES=214, CREATE_USER=215, 
		DELETE_USER=216, MODIFY_PASSWORD=217, LIST_USER=218, GRANT_USER_PRIVILEGE=219, 
		REVOKE_USER_PRIVILEGE=220, GRANT_USER_ROLE=221, REVOKE_USER_ROLE=222, 
		CREATE_ROLE=223, DELETE_ROLE=224, LIST_ROLE=225, GRANT_ROLE_PRIVILEGE=226, 
		REVOKE_ROLE_PRIVILEGE=227, CREATE_FUNCTION=228, DROP_FUNCTION=229, CREATE_TRIGGER=230, 
		DROP_TRIGGER=231, START_TRIGGER=232, STOP_TRIGGER=233, CREATE_CONTINUOUS_QUERY=234, 
		DROP_CONTINUOUS_QUERY=235, SHOW_CONTINUOUS_QUERIES=236, SCHEMA_REPLICATION_FACTOR=237, 
		DATA_REPLICATION_FACTOR=238, TIME_PARTITION_INTERVAL=239, SCHEMA_REGION_GROUP_NUM=240, 
		DATA_REGION_GROUP_NUM=241, APPLY_TEMPLATE=242, UPDATE_TEMPLATE=243, READ_TEMPLATE=244, 
		READ_TEMPLATE_APPLICATION=245, MINUS=246, PLUS=247, DIV=248, MOD=249, 
		OPERATOR_DEQ=250, OPERATOR_SEQ=251, OPERATOR_GT=252, OPERATOR_GTE=253, 
		OPERATOR_LT=254, OPERATOR_LTE=255, OPERATOR_NEQ=256, OPERATOR_BETWEEN=257, 
		OPERATOR_IS=258, OPERATOR_IN=259, OPERATOR_AND=260, OPERATOR_OR=261, OPERATOR_NOT=262, 
		OPERATOR_CONTAINS=263, DOT=264, COMMA=265, SEMI=266, STAR=267, DOUBLE_STAR=268, 
		LR_BRACKET=269, RR_BRACKET=270, LS_BRACKET=271, RS_BRACKET=272, DOUBLE_COLON=273, 
		STRING_LITERAL=274, DURATION_LITERAL=275, DATETIME_LITERAL=276, INTEGER_LITERAL=277, 
		EXPONENT_NUM_PART=278, BOOLEAN_LITERAL=279, NULL_LITERAL=280, NAN_LITERAL=281, 
		ID=282, QUOTED_ID=283, DEVICEID=284;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"COLLECTOR", "CONCAT", "CONDITION", "CONFIGNODES", "CONFIGURATION", "CONNECTOR", 
			"CONTINUOUS", "CONTAIN", "COUNT", "CQ", "CQS", "CREATE", "DATA", "DATABASE", 
			"DATABASES", "DATANODEID", "DATANODES", "DEACTIVATE", "DEBUG", "DELETE", 
			"DESC", "DESCRIBE", "DETAILS", "DEVICE", "DEVICES", "DISABLE", "DISCARD", 
			"DROP", "ELAPSEDTIME", "END", "ENDTIME", "EVERY", "EXPLAIN", "FILL", 
			"FILE", "FIRST", "FLUSH", "FOR", "FROM", "FULL", "FUNCTION", "FUNCTIONS", 
			"GLOBAL", "GRANT", "GROUP", "HAVING", "INDEX", "INFO", "INSERT", "INTO", 
			"KILL", "LABEL", "LAST", "LATEST", "LEVEL", "LIKE", "LIMIT", "LINEAR", 
			"LINK", "LIST", "LOAD", "LOCAL", "LOCK", "MERGE", "METADATA", "MIGRATE", 
			"MODEL", "MODELS", "NODEID", "NODES", "NONE", "NOW", "NULLS", "OF", "OFF", 
			"OFFSET", "ON", "ORDER", "ONSUCCESS", "PARTITION", "PASSWORD", "PATHS", 
			"PIPE", "PIPES", "PIPESINK", "PIPESINKS", "PIPESINKTYPE", "PIPEPLUGIN", 
			...
			"TRIGGERS", "TTL", "UNLINK", "UNLOAD", "UNSET", "UPDATE", "UPSERT", "URI", 
			"USED", "USER", "USING", "VALUES", "VARIABLES", "VARIATION", "VERIFY", 
	...
	public final KeyWordsContext keyWords() throws RecognitionException {
		...
		try {
			...
			setState(10);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & -1152921505714143236L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & -36028806212878337L) != 0) || ((((_la - 128)) & ~0x3f) == 0 && ((1L << (_la - 128)) & 8646884209077516285L) != 0) || ((((_la - 192)) & ~0x3f) == 0 && ((1L << (_la - 192)) & 15855L) != 0) || _la==DEVICEID) ) {
