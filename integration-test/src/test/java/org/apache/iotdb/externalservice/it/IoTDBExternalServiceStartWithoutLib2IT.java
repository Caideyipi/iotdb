...
public class IoTDBExternalServiceStartWithoutLib2IT extends IoTDBExternalServiceStartWithoutLibIT {
  ...
  public void setUp() throws Exception {
    ...
    try {
      ...
      serviceName = BuiltinExternalServices.REST.getServiceName();
      return;
    }
    fail();
  }
