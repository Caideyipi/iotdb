...
public class IoTDBPipeMetaHistoricalIT extends AbstractPipeDualTreeModelManualIT {
  ...
  public void testTemplateInclusion() throws Exception {
    ...
    try (final SyncConfigNodeIServiceClient client =
      ...
      sourceAttributes.put(
          "source.inclusion.exclusion", "schema.timeseries.ordinary, schema.timeseries.view");
  ...
  public void testAuthInclusion() throws Exception {
    ...
    try (final SyncConfigNodeIServiceClient client =
      ...
      TestUtils.assertDataEventuallyOnEnv(
          ...
          ColumnHeaderConstant.USER_ID
              + ","
              + ColumnHeaderConstant.USER
              + ","
              + ColumnHeaderConstant.MAX_SESSION_PER_USER
              + ","
              + ColumnHeaderConstant.MIN_SESSION_PER_USER
              + ",",
          Collections.singleton("10000,thulab,-1,-1,"));
      TestUtils.assertDataEventuallyOnEnv(
          receiverEnv,
  ...
  public void testLogicalViewInclusion() throws Exception {
    ...
    try (final SyncConfigNodeIServiceClient client =
      ...
      sourceAttributes.put("extractor.inclusion.exclusion", "schema.timeseries.template");
      sourceAttributes.put("user", "root");
      ...
      sinkAttributes.put("connector.exception.conflict.resolve-strategy", "retry");
      sinkAttributes.put("connector.exception.conflict.retry-max-time-seconds", "-1");
