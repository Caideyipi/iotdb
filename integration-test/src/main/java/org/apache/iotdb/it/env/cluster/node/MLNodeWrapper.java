...
public class MLNodeWrapper implements BaseNodeWrapper {
  ...
  private static final String SCRIPT_FILE = "start-mlnode.sh";

  private static final String SHELL_COMMAND = "bash";

  private static final String PROPERTIES_FILE = "iotdb-mlnode.properties";
